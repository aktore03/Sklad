...
namespace Sklad.Controllers
{
    public class StoragesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.Type = new SelectList(new List<string>() { "Электроника", "Мебель", "Концилярский товар" });
            return View();
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Name,Type,Quantity,Desk,Data")] Storage storage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Type,Quantity,Desk,Data")] Storage storage)
        {
            if (id != storage.Id)
            {
                return NotFound();
